...
export default function profile() {
  ...
  return (
    <div className="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover bg-black">
        ...
        >
          <div className="p-4 md:p-12 text-center lg:text-left">
            ...
            <div className="pt-12 pb-8">
              <a href={meta.contactLink} target="_blank" className="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full">
                Get In Touch
              </a>
            </div>
